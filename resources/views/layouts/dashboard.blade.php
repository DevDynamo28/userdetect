    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-gray-900 text-white flex-shrink-0" :class="{ 'hidden': !sidebarOpen }">
            ...
            <nav class="mt-4">
                ...
                <a href="{{ route('dashboard.api-tester') }}"
                   class="flex items-center px-6 py-3 text-sm {{ request()->routeIs('dashboard.api-tester') ? 'bg-gray-800 text-white border-r-2 border-indigo-400' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
