...
<?php $__env->startSection('page-title', 'Documentation'); ?>
...
<div class="max-w-4xl space-y-8">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="prose prose-sm max-w-none text-gray-700">
            ...
            <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto my-3">
                <pre class="text-sm text-green-400"><code>&lt;script src="<?php echo e(url('/sdk/userdetect.min.js')); ?>"&gt;&lt;/script&gt;</code></pre>
            </div>
  ...
  "timestamp": "2026-02-17T14:30:00Z"
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
            <pre class="text-sm text-green-400"><code>{
  apiEndpoint: '<?php echo e(url('/api')); ?>',  // Recommended: explicitly set your API base URL
        ...
        <div class="space-y-4" x-data="{ open: null }">
            ...
            <div class="border border-gray-200 rounded-lg">
                <button @click="open = open === <?php echo e($i); ?> ? null : <?php echo e($i); ?>"
                    ...
                    <svg class="w-4 h-4 text-gray-400 transition-transform" :class="{ 'rotate-180': open === <?php echo e($i); ?> }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
                <div x-show="open === <?php echo e($i); ?>" x-cloak class="px-4 pb-3 text-sm text-gray-600">
                    <?php echo e($a); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\IP Detect\resources\views/dashboard/docs.blade.php ENDPATH**/ ?>